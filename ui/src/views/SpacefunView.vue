    ...
    <SideNav></SideNav>
      ...
      <v-card min-width="280%" height="80%" class="scroll">
        ...
        <v-card-item v-for="spacefun in state.spacefuns" :key="spacefun._id">
              <v-row class="justify-space-between">
                <v-col cols="3">
                  <router-link :to="`/spacefunDetail/${spacefun._id}`">
                  {{ spacefun.name }}
                  </router-link>
                  </v-col>
      ...
      <v-card>
        ...
        <v-card-item>
          ...
          <v-text-field
            ...
            label="Please enter a title for your SpaceFun"
            hide-details="auto"
            variant="underlined"
            ></v-text-field>
            </v-col>
        ...
        <v-card-text>
          <v-container>
            <v-row>
              <v-col cols="12">
                <v-text-field
                  v-model="spaceFunToEdit.name"
                  variant="underlined"
                  label="Please eneter the new name"
                  required
                ></v-text-field>
              </v-col>
            </v-row>
